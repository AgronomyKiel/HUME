...
{Demonstrates contour drawing features of MathImage, as well as the use
 ...
 to a) speed up things a lot, b) allow me to use more grid points.}
...
begin
  ...
  begin
    ...
    begin
      //The following is what takes long
...
procedure TContourform.CopytoClipboard1Click(Sender: TObject);
begin
  with GraphImage do
    Clipboard.assign(Bitmap);
end;

procedure TContourform.SaveasMetafile1Click(Sender: TObject);
begin
{$IFDEF WIN32}
  with SaveDialog1 do
