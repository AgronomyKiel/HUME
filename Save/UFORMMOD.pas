...
uses
  ...
  Buttons, ToolWin, IniFiles, AdvGrid, VCLTee.TeeProcs, VCLTee.TeEngine,
  ...
  UVisualization, VCLTee.TeeGDIPlus, System.ImageList,
  VCLTee.TECanvas, System.UITypes; // , JvCsvData;
...
begin
  ...
  begin
    ...
    if not DirectoryExists(InitialDir) then
      InitialDir := ExtractFileDir(Lmod.fModel.ControlFileFn);
    ...
    begin
      ...
      index := 0;
      while not eof(Lmod.fModel.ControlFile) do
      begin
