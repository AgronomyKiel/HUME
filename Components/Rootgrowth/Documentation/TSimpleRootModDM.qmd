...
\qquad \text{for } j = n\_age\_cl, \dots, 2
$$ {#eq-boxcarShift}
...
$$
\Delta WL_i(t) = \max \left(0,\; WL_i(t) - WL_i(t-1)\right)
$$ {#eq-rootIncrement}

This increment is assigned to the youngest age class:

$$
RootMatrix_{i,1}(t) = \Delta WL_i(t)
$$ {#eq-newRootLength}
...
$$
SRL_{eff}(t) = \sum_i EffWL_i(t)
$$ {#eq-totalEffectiveRootLength}
...
$$
EffWLD_i(t) = \frac{EffWL_i(t)}{\Delta z_i}
$$ {#eq-effectiveRootLengthDensity}
