...
/// <summary>
/// The main class for the root growth model in the HUME system.
/// </summary>
/// <remarks>
/// This class represents the root growth model and is a subclass of <c>TPlantRelatedSubMod</c>.
/// It contains properties and methods related to root growth and root length density calculations,
/// as well as a coupled soil water model and a list of texture effects.
/// </remarks>
...
/// <summary>
/// Calculates the root length density as a function of depth.
/// </summary>
/// <param name="wld0">Root length density at z=0 [cm/cm³].</param>
/// <param name="a">Fit parameter [1/cm], at 1/a is WLD=0.63*WLD0.</param>
/// <param name="z">Depth under GOF [cm].</param>
/// <returns>Root length density at depth z [cm/cm³].</returns>
...
/// <summary>
/// Calculates the root length density between two depths.
/// </summary>
/// <remarks>
/// Purpose: Function to calculate the root length density between two depths.
/// </remarks>
/// <param name="z1">Depth 1 [cm]</param>
/// <param name="z2">Depth 2 [cm]</param>
/// <param name="t">Time [d]</param>
/// <param name="Zrmax">Maximum rooting depth [cm]</param>
/// <param name="zr0">Rooting depth at t=0 [cm]</param>
/// <param name="kz">Fit parameter [1/d]</param>
/// <param name="SRLmax">Maximum root length [cm/cm²] (1 cm/cm² = 0.1 km/m²)</param>
/// <param name="SR0">Root length at t=0 [cm/cm²]</param>
/// <param name="kL">Fit parameter [1/d]</param>
/// <param name="ka">Fit parameter [1/cm], at 1/(ka*zr) is WLD=0.63*WLD0</param>
/// <returns>WLD_z_t_f: WLD between z1 and z2 at t [cm/cm³]</returns>
...
begin
  ...
  if (TextureEffect.Option = 'true') and (self.RootedSoilWaterModel <> NIL) then begin
    ...
    /// construct index string from texture and LD
