...
Tsubleafareagrowth = class(TSubmodel)
...
procedure Tsubleafareagrowth.createAll;
var
  i : integer;
...
procedure Tsubleafareagrowth.init(var GlobMod: TMod);
...
procedure Tsubleafareagrowth.CalcRates;
...
begin
   ...
   else  If  (ISTAGE.v>=4) and (ISTAGE.v<5)
...
procedure Tsubleafareagrowth.Integrate;
...
procedure Register;
begin
  RegisterComponents('Ceres Wheat', [Tsubleafareagrowth]);
end;
