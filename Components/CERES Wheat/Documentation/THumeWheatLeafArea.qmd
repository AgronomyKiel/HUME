...
Optionally, the effect of self shading on leaf senescence can be considered. The light dependent leaf senescence is calculated from the leaf area index if the 10 day average of radiation (PAR~av~) \[MJ^.^m^-2.^d^-1^\] is falling below a threshold value named I~crit~. The threshold value is set to 0.2 \[MJ^.^m^-2.^d^-1^\] in the model, which is much lower than the value of 1 \[MJ^.^m^-2.^d^-1^\] from @Meinke1998.
