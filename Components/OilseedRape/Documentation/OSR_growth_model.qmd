...
Total dry matter growth is split between growth of root dry matter (DMRoot \[g m^-2^\], eq. 12) and shoot dry matter (DMShoot \[g m^-2^\], eq. 13). Before stem elongation, root dry matter growth depends on the temperature sum from emergence. The ratio dDMRoot/dDMPlant (fRoot, eq. 11) is described by an exponential function of the temperature sum after emergence (TempSumEmerge) with a base temperature of 3°C. From the beginning of stem elongation, fRoot decreased linearly to a minimum of 0.05 within 100°Cd. After flowering, it was assumed that 5% of total dry matter increase was allocated to the roots (Barraclough 1989).
