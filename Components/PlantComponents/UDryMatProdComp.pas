...
type
  ...
  public
    ...
    Tempf_T1, Tempf_T2, Tempf_T3, Tempf_T4: TPar;
    // 4 Cardinal Points of Funktion for temperature Response function [0..1].
    Q10: TPar; //
    RespOptions: TRespOptions;

    Transmission: TVar;

    PAR, LAI, Temp, TotalDrymatterGr: TExternV;
    LUE: TVar;
  ...
  published
    ...
    Property Ex_TotalDrymatterGr: TExternV read TotalDrymatterGr
      write TotalDrymatterGr;
