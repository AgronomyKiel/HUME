unit Usublightint_growth_Maize_noN;
...
Tsublightint_growth_Maize_noN = class(TSubmodel)
...
Procedure Tsublightint_growth_Maize_noN.SetSoilWaterMod(SoilWaterMod: TSoilWaterModelR);
begin
...
begin
  ...
  ParCreate('consLUE', '[g/MJ]',   3,  consLUE);
...
procedure Tsublightint_growth_Maize_noN.init(var GlobMod: TMod);
...
procedure Tsublightint_growth_Maize_noN.CalcRates;
...
procedure Register;
begin
  RegisterComponents('Maize', [Tsublightint_growth_Maize_noN]);
end;
