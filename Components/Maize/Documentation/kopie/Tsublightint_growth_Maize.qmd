...
Within season, daily dry matter production ($\frac{\mathrm{dDM}_{\mathrm{tot}}}{\mathrm{dt}}$\$\\frac{\\mathrm{dDM}\_{\\mathrm{tot}}}{\\mathrm{dt}}\$) is driven by absorbed photosynthetic radiation (Q, MJ m^-2^ d^-1^) and potential light use efficiency (LUE, g MJ^-1^ PAR^-1^).
