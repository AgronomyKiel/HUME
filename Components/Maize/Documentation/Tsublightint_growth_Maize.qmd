...
Within season, daily dry matter production ($\frac{dDM_{tot}}{dt}$) is driven by absorbed photosynthetic radiation (Q, MJ m^-2^ d^-1^) and potential light use efficiency (LUE, g MJ^-1^ PAR^-1^):
