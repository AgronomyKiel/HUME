...
public
     ...
     Power_f  : TPar;             /// power factor for uneven layer thickness
     ...
     upper_w_f : TSoilArray;       /// Wichtungsfaktoren zur Errechnung der mittleren Leitfähigkeit zwischen 2 Kompartimenten }
...
begin
  inherited CreateAll;
  n_comp := 20;
  ParCreate('MaxDepth', '[cm]', 200.0, MaxProfileDepth, 'maximum depth of calculated profile');
  ParCreate('Potenz_f', '[]', 1.0, Power_f, 'factor for uneven layer depth distribution');
