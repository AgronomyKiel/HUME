...
public
  ...
  TransRatio : TVar;       /// Verh�ltnis aktuelle zu potentielle Transpiration
  TransIntRatio : TVar;    /// Verh�ltnis aktuelle zu potentielle Transpiration
...
begin
  ...
  OptCreate('WriteMFPTable', 'false', WriteMFPTable, 'Option for MFP tables for each layer as txt-file');
