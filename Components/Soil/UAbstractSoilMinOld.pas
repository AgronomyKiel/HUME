...
type
  ...
  TAbstractSoilMinOld = class(TPlantRelatedSubMod)
  protected
...
procedure TAbstractSoilMinOld.CreateAll;
var
  layer: integer;
begin
  inherited Createall;
...
procedure TAbstractSoilMinOld.Init;
var
  layer: integer;
begin
  inherited;
...
procedure TAbstractSoilMinOld.AddResidues(Carbon, nitrogen:real);
begin

end;

procedure TAbstractSoilMinOld.MixLayers(depth: real);
begin
end;
