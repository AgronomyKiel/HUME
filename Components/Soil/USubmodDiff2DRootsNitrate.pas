unit USubmodDiff2DRootsNitrate;
...
/// <summary>Klassen</summary>
  TSubmodDiff2DRootsNitrate = class(TBaseSubmodRootDiff)
...
/// <summary>Protected declarations, also accessible from derived classes</summary>
    ...
    /// <summary>minimum concentration [mol/cm3] </summary>
    clmin,
...
function TSubmodDiff2DRootsNitrate.influx_fVar(Imax, Km, ClAv, x, Db: double): real;
(* ------------------------------------------------------------------------------
...
(* -----------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------------ *)
procedure TSubmodDiff2DRootsNitrate.createAll;
(* ------------------------------------------------------------------------------
  DESCRIPTION:
...
procedure TSubmodDiff2DRootsNitrate.AddDataValueToDataSeries;
(* ------------------------------------------------------------------------------
...
begin
  ...
  InitConc;
  N_amountsoil.v := Mg_func(SizeLayer.v, theta.v, c_start.v); // Debuggen
  c_av.v := avg_conz;
