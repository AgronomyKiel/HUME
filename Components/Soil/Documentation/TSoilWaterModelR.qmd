...
$$psi2_{hightrans} = max \left(psi_2-\frac{psi2_{diff}}{2}, psi_{FK} \right)$$ {#eq-psi2Feddes_hightrans}


$$psi2_{lowtrans} = max\left(psi_2+\frac{psi_{2diff}}{2}, psi_{PWP}\right)$$ {#eq-psi2Feddes_hightrans}
