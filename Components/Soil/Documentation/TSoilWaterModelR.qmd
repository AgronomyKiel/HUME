...
- psi_logscale: The option *psi_logscale* is an option to consider the soil water potential in log scale for the calculation of the reduction factor for root water uptake (f~sinkred~) (see @eq-fsinkred and @eq-fsinkredfeddes). 
...
#| message: false
#| warning: false
#| fig-cap: Example for the calculation of the reduction factor for root water uptake (f~sinkred~) based on the soil water potential in each soil layer (psi~i~) and the actual transpiration rate (T~act~) based on a Feddes-like approach [@feddes1978]. The parameters psi2_hightrans <- 200
psi2_lowtrans <- 2000
Trefhigh <- 6
Treflow <- 1
