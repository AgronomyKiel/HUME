...
public
  ...
  f_rec     : TPar;        //recovery factor, only this fraction will be added as fertilizer
  f_ExtFertSens: TExternV; // factor to change in sensitivity analysis to change fertilizer rate, set in TInput
...
begin
  while i > DList.Count do DList.Add(nil);
  if i = DList.Count then DList.Add(st) else DList[i] := st;
end;
