...
type
  ...
  /// possible shapes for graphical representation of submodels
...
/// Enumeration type for options of continous output
/// NoContOutput: no continous output
/// AllContoutput: output of all variables in each time step
/// SubmodelSpecific: output of variables selected in each submodel 
...
/// string constants for Model element names
...
/// <summary> TMod is a class representing the central, coordination model object within in the simulation framework HUME. 
/// It provides methods for simulation process control, parameter estimation, and statistical quality control. 
/// It further controls output of simulation results </summary> 
  TMod = class;
...
{$ENDIF}
  ...
  public
    ...
    /// field for the selection of the optimization option
...
///
    ...
    ///
    fContOutput: TContOutput; /// option for continous output of simulation results
